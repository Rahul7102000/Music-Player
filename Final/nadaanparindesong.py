...
class nps(QMainWindow):
    def __init__(self):
        super(nps, self).__init__()
        loadUi("nadaan parinde song.ui", self)
        ...
        # Song 1
        self.play44.clicked.connect(self.playfunction44)
        self.pause44.clicked.connect(self.pausefunction44)
        self.resume44.clicked.connect(self.resumefunction44)

    def playfunction44(self):
        pygame.mixer.init()
        pygame.mixer.music.load("../music/AR Rahman/Nadaan Parindey.mp3")
        pygame.mixer.music.play()

    def pausefunction44(self):
        pygame.mixer.init()
        pygame.mixer.music.pause()

    def resumefunction44(self):
        pygame.mixer.init()
