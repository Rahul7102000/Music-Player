...
class ys(QMainWindow):
    def __init__(self):
        super(ys, self).__init__()
        loadUi("yalgaar song.ui", self)
        ...
        # Song 1
        self.play69.clicked.connect(self.playfunction69)
        self.pause69.clicked.connect(self.pausefunction69)
        self.resume69.clicked.connect(self.resumefunction69)

    def playfunction69(self):
        pygame.mixer.init()
        pygame.mixer.music.load("../music/Yalgaar.mp3")
        pygame.mixer.music.play()

    def pausefunction69(self):
        pygame.mixer.init()
        pygame.mixer.music.pause()

    def resumefunction69(self):
        pygame.mixer.init()
